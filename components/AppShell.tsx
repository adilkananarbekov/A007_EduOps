...
const navigation = [
  { href: "/dashboard", label: "Overview", icon: "OV", hint: "Live summary" },
  { href: "/users", label: "Users", icon: "US", hint: "Roles and groups" },
  { href: "/learning", label: "Learning", icon: "LR", hint: "Lessons and tests" },
  { href: "/profile", label: "Profile", icon: "ME", hint: "Current account" },
];
      ...
      <aside className="workspace-sidebar">
        <div className="brand-card">
          ...
          <div>
            ...
            <p className="brand-subtitle">Academic workspace</p>
          </div>
        </div>
